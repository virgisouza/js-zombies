...
Player.prototype.discardItem = function (item) {
  var getItem = this._pack.indexOf(item);

    if(getItem === -1){
      console.log(item + ' could not be found. No ' + item + 'discarded.');
      return false;
    }else{
      this.getPack().splice(getItem, 1);
      console.log(name + ', ' + item + ' was discarded.');
      return true;
    }
}
